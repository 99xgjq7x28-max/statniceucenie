...
const planDays = [
  { date: '2026-06-24', label: '24.6.', goal: 'Seriózny štart: E 1-3', ranges: [['Ekonómia a financie', 1, 3]] },
  { date: '2026-06-25', label: '25.6.', goal: 'Prvý prejazd: M 1-3', ranges: [['Manažment', 1, 3]] },
  { date: '2026-06-26', label: '26.6.', goal: 'Prvý prejazd: E 4-6', ranges: [['Ekonómia a financie', 4, 6]] },
  { date: '2026-06-27', label: '27.6.', goal: 'Prvý prejazd: M 4-6', ranges: [['Manažment', 4, 6]] },
  { date: '2026-06-28', label: '28.6.', goal: 'Dobehnutie a krátke opakovanie', mode: 'weekly-review', count: 8 },
  { date: '2026-06-29', label: '29.6.', goal: 'Prvý prejazd: E 7-9', ranges: [['Ekonómia a financie', 7, 9]] },
  { date: '2026-06-30', label: '30.6.', goal: 'Prvý prejazd: M 7-9', ranges: [['Manažment', 7, 9]] },
  { date: '2026-07-01', label: '1.7.', goal: 'Prvý prejazd: E 10-12', ranges: [['Ekonómia a financie', 10, 12]] },
  { date: '2026-07-02', label: '2.7.', goal: 'Prvý prejazd: M 10-12', ranges: [['Manažment', 10, 12]] },
  { date: '2026-07-03', label: '3.7.', goal: 'Prvý prejazd: E 13-15', ranges: [['Ekonómia a financie', 13, 15]] },
  { date: '2026-07-04', label: '4.7.', goal: 'Prvý prejazd: M 13-15', ranges: [['Manažment', 13, 15]] },
  { date: '2026-07-05', label: '5.7.', goal: 'Dobehnutie a slabé miesta', mode: 'weekly-review', count: 10 },
  { date: '2026-07-06', label: '6.7.', goal: 'Prvý prejazd: E 16-18', ranges: [['Ekonómia a financie', 16, 18]] },
  { date: '2026-07-07', label: '7.7.', goal: 'Prvý prejazd: M 16-18', ranges: [['Manažment', 16, 18]] },
  { date: '2026-07-08', label: '8.7.', goal: 'Prvý prejazd: E 19-21', ranges: [['Ekonómia a financie', 19, 21]] },
  { date: '2026-07-09', label: '9.7.', goal: 'Prvý prejazd: M 19-21', ranges: [['Manažment', 19, 21]] },
  { date: '2026-07-10', label: '10.7.', goal: 'Prvý prejazd: E 22-24', ranges: [['Ekonómia a financie', 22, 24]] },
  { date: '2026-07-11', label: '11.7.', goal: 'Prvý prejazd: M 22-24', ranges: [['Manažment', 22, 24]] },
  { date: '2026-07-12', label: '12.7.', goal: 'Dobehnutie a hlasné odpovede', mode: 'weekly-review', count: 12 },
  { date: '2026-07-13', label: '13.7.', goal: 'Prvý prejazd: E 25-27', ranges: [['Ekonómia a financie', 25, 27]] },
  { date: '2026-07-14', label: '14.7.', goal: 'Prvý prejazd: M 25-27', ranges: [['Manažment', 25, 27]] },
  { date: '2026-07-15', label: '15.7.', goal: 'Prvý prejazd: E 28-30', ranges: [['Ekonómia a financie', 28, 30]] },
  { date: '2026-07-16', label: '16.7.', goal: 'Prvý prejazd: M 28-30', ranges: [['Manažment', 28, 30]] },
  { date: '2026-07-17', label: '17.7.', goal: 'Druhý prejazd: E 1-6', ranges: [['Ekonómia a financie', 1, 6]] },
  { date: '2026-07-18', label: '18.7.', goal: 'Druhý prejazd: E 7-12', ranges: [['Ekonómia a financie', 7, 12]] },
  { date: '2026-07-19', label: '19.7.', goal: 'Slabé Eko + dobehnutie', mode: 'subject-review', subject: 'Ekonómia a financie', count: 8 },
  { date: '2026-07-20', label: '20.7.', goal: 'Druhý prejazd: E 13-18', ranges: [['Ekonómia a financie', 13, 18]] },
  { date: '2026-07-21', label: '21.7.', goal: 'Druhý prejazd: E 19-24', ranges: [['Ekonómia a financie', 19, 24]] },
  { date: '2026-07-22', label: '22.7.', goal: 'Druhý prejazd: E 25-30', ranges: [['Ekonómia a financie', 25, 30]] },
  { date: '2026-07-23', label: '23.7.', goal: 'Druhý prejazd: M 1-6', ranges: [['Manažment', 1, 6]] },
  { date: '2026-07-24', label: '24.7.', goal: 'Druhý prejazd: M 7-12', ranges: [['Manažment', 7, 12]] },
  { date: '2026-07-25', label: '25.7.', goal: 'Druhý prejazd: M 13-18', ranges: [['Manažment', 13, 18]] },
  { date: '2026-07-26', label: '26.7.', goal: 'Slabý Manažment + dobehnutie', mode: 'subject-review', subject: 'Manažment', count: 8 },
  { date: '2026-07-27', label: '27.7.', goal: 'Druhý prejazd: M 19-24', ranges: [['Manažment', 19, 24]] },
  { date: '2026-07-28', label: '28.7.', goal: 'Druhý prejazd: M 25-30', ranges: [['Manažment', 25, 30]] },
  { date: '2026-07-29', label: '29.7.', goal: 'Mix slabých otázok', mode: 'mixed-review', count: 12 },
  { date: '2026-07-30', label: '30.7.', goal: 'Prepájanie pojmov a príkladov', mode: 'mixed-review', count: 10 },
  { date: '2026-07-31', label: '31.7.', goal: 'Krátke odpovede nahlas: mix', mode: 'mixed-review', count: 10 },
  { date: '2026-08-01', label: '1.8.', goal: 'Hovorenie nahlas: E 1-10 + M 1-10', ranges: [['Ekonómia a financie', 1, 10], ['Manažment', 1, 10]] },
  { date: '2026-08-02', label: '2.8.', goal: 'Voľnejší deň alebo dobiehanie', mode: 'light-review', count: 6 },
  { date: '2026-08-03', label: '3.8.', goal: 'Hovorenie nahlas: E 11-20 + M 11-20', ranges: [['Ekonómia a financie', 11, 20], ['Manažment', 11, 20]] },
  { date: '2026-08-04', label: '4.8.', goal: 'Hovorenie nahlas: E 21-30 + M 21-30', ranges: [['Ekonómia a financie', 21, 30], ['Manažment', 21, 30]] },
  { date: '2026-08-05', label: '5.8.', goal: 'Simulácia: E 1-15', ranges: [['Ekonómia a financie', 1, 15]] },
  { date: '2026-08-06', label: '6.8.', goal: 'Simulácia: E 16-30', ranges: [['Ekonómia a financie', 16, 30]] },
  { date: '2026-08-07', label: '7.8.', goal: 'Simulácia: M 1-15', ranges: [['Manažment', 1, 15]] },
  { date: '2026-08-08', label: '8.8.', goal: 'Simulácia: M 16-30', ranges: [['Manažment', 16, 30]] },
  { date: '2026-08-09', label: '9.8.', goal: 'Voľnejší deň alebo dobiehanie', mode: 'light-review', count: 6 },
  { date: '2026-08-10', label: '10.8.', goal: 'Skúška na čas: 6 náhodných otázok', mode: 'mixed-review', count: 6 },
  { date: '2026-08-11', label: '11.8.', goal: 'Skúška na čas: 6 slabých otázok', mode: 'mixed-review', count: 6 },
  { date: '2026-08-12', label: '12.8.', goal: 'Finále: 12 najslabších', mode: 'mixed-review', count: 12 },
  { date: '2026-08-13', label: '13.8.', goal: 'Finále: ekonomické jadro', mode: 'subject-review', subject: 'Ekonómia a financie', count: 8 },
  { date: '2026-08-14', label: '14.8.', goal: 'Finále: manažérske jadro', mode: 'subject-review', subject: 'Manažment', count: 8 },
...
function renderTodayPlan() {
  ...
  const carryover = carryoverDays(day);
  const topics = topicsForVisibleDay(day);
  const isExamDay = day.mode === 'exam';
  $('#todayPlanLabel').textContent = isExamDay
    ? `${day.label} - ${day.goal}`
    : `${day.label} - ${day.goal} (${topics.length || 'podľa progresu'} otázok${carryover.length ? `, z toho ${carryover.length} rozrobené dni` : ''})`;
...
function renderCalendar() {
  $('#planDaysList').innerHTML = planDays.map((day) => {
    ...
    const overdue = day.date < todayKey() && !done && day.mode !== 'exam';
    const counts = countGrades(topics);
    return `
      <article class="plan-day ${today ? 'is-today' : ''} ${done ? 'is-complete' : ''} ${overdue ? 'is-overdue' : ''}">
...
function topicsForVisibleDay(day) {
  return uniqueTopics([
    ...carryoverDays(day).flatMap((carryDay) => topicsForDay(carryDay)),
    ...topicsForDay(day)
  ]);
}

function carryoverDays(day) {
  return planDays.filter((candidate) =>
    candidate.date < day.date &&
    candidate.date <= todayKey() &&
    !planState.plan.completedDays[candidate.date] &&
    candidate.mode !== 'exam'
  );
}
...
function nextMilestoneText() {
  ...
  const firstUnfinished = planDays.find((day) => day.date <= today && !planState.plan.completedDays[day.date] && day.mode !== 'exam')
    || planDays.find((day) => !planState.plan.completedDays[day.date]);
...
function uniqueTopics(items) {
  ...
  return items.filter((topic) => {
    if (!topic || seen.has(topic.id)) return false;
    seen.add(topic.id);
    return true;
  });
}
